...
def train(train_loader, model, criterion, optimizer, cur_epoch):
    print('\nEpoch: %d' % cur_epoch)
    train_loss = 0
    correct = 0
    total = 0
...
if __name__ == '__main__':
    ############# LOAD DATASET ###########
    train_loader, test_loader = pre.IO_preprocess(N_BATCH_SIZE, False) # make them together
    ...
    #    train(train_loader, model, criterion, optimizer, cur_epoch)
