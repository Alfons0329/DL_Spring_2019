"""
Full VGG16 version in this python code, original version is VGG16_arch and reduced is VGG16_arch_small due to the hardware limitation of compute capability
Please run with --vgg_normal if you have HW such like TITAN V

Teammate HW as follows:
    CPU = AMD A10 7850K
    GPU = NVIDIA TITAN V
    RAM = 32GB DDR4
    SSD = PM981 512GB
...
def make_graph():
    ...
    plt.legend()
    plt.savefig('VGG16full_' + str(N_LEARN_RATE) + '_' + str(N_BATCH_SIZE) + '_' + 'ACC' + '.png', dpi = 150)
    ...
    plt.savefig('VGG16full_' + str(N_LEARN_RATE) + '_' + str(N_BATCH_SIZE) + '_' + 'LC' + '.png', dpi = 150)
